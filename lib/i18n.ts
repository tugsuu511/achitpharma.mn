  ...
  mn: {
    ...
    products: {
      ...
      advaIron: {
        ...
        imageAlt: "Adva-Iron Бүтээгдэхүүн",
        benefits: {
          0: "Дархлааг дэмжинэ",
          1: "Цус төлжүүлнэ",
          2: "Ядаргаа тайлна",
      ...
      advaBiotics: {
        ...
        imageAlt: "Adva-Biotics Бүтээгдэхүүн",
        benefits: {
          0: "Хоол боловсруулалтыг сайжруулна",
          1: "Дархлааг дэмжинэ",
          2: "Цайрын дутагдлыг нөхнө",
        },
      },
      aclavcare: {
        name: "Aclavcare",
        ...
        badge: "Антибиотик",
        imageAlt: "Aclavcare Бүтээгдэхүүн",
        benefits: {
          0: "Бактерийн халдварын эсрэг",
          1: "Үрэвсэл дарна",
          2: "Хурдан үйлчилгээтэй",
        },
      },
      mozincare: {
        name: "Mozincare",
        ...
        badge: "Сироп",
        imageAlt: "Mozincare Бүтээгдэхүүн",
        benefits: {
          0: "Цайр, Молибден агуулсан",
          1: "Бодисын солилцоог дэмжинэ",
          2: "Өсөлт хөгжилтөд тустай",
        },
      },
  ...
  en: {
    ...
    products: {
      ...
      advaIron: {
        ...
        badge: "Iron jelly",
        imageAlt: "Adva-Iron Product",
        benefits: {
          0: "Supports immunity",
          1: "Promotes blood health",
          2: "Relieves fatigue",
          3: "Supports growth",
        },
      },
      ...
      mozincare: {
        ...
        badge: "Health",
        imageAlt: "Mozincare Product",
        benefits: {
          0: "Contains Zinc & Molybdenum",
