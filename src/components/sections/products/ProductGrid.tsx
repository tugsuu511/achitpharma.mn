  ...
  return (
    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
      {products.map((product) => (
        <div
          key={product.id}
          className="group flex h-full flex-col rounded-2xl border bg-background p-4 shadow-sm transition hover:shadow-md"
        >
            ...
            <Link href={`/products/${product.id}`} className="block">
              ...
              <div className="mt-4 flex items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <div className="mt-1 min-h-[2.5rem] line-clamp-2 text-sm leading-5 text-muted-foreground">
                    {product.description}
                  </div>
                </div>
